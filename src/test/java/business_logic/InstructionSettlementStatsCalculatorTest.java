...
public class InstructionSettlementStatsCalculatorTest {
    ...
    private static final LocalDate MONDAY    = LocalDate.of(2018, 3, 20);
    private static final LocalDate TUESDAY   = LocalDate.of(2018, 3, 21);
    private static final LocalDate WEDNESDAY = LocalDate.of(2018, 3, 22);
    private static final LocalDate SATURDAY  = LocalDate.of(2018, 3, 18);
    private static final LocalDate SUNDAY    = LocalDate.of(2018, 3, 19);
